  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] placeholder-[#00B4D8]",
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive placeholder-[#00B4D8] bg-[#CAF0F8] italic",
        className
      )}
      {...props} />
  );
