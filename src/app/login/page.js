...
const Login = () => {
  ...
  const [user, setUser] = useState({
    email: "", // Initialized with empty string
    password: "", // Initialized with empty string
  })
        ...
        <div className='mx-auto flex justify-around items-center'>
          <div className='w-screen md:w-[500px] flex items-center justify-center'>
            <div className='w-full'>
              ...
              <h2 className='text-center text-xl flex justify-center items-center mt-7 font-semibold relative w-[350px] h-[40px] mx-auto bg-[#103C63] rounded-3xl -mb-4 text-[#CAF0F8]'>
                {loading ? "Processing" : "Signin To Your Account"}
              </h2>
                ...
                <div className="rounded px-8 pt-6 pb-8 mb-4 w-5/6 mx-auto">
                  <div className="mb-4">
                    ...
                    <Input
                      ...
                      id="email"
                      name="email"
                      value={user.email} // Use user.email instead of user.username
                  ...
                  <div className="flex items-center justify-between">
                    <Button
                      className="w-[80%] mx-auto bg-[#103C63] hover:bg-[#103c63b4] cursor-pointer"
                      onClick={onLogin}
